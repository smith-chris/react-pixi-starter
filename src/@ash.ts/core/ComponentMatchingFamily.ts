 ...
 */
export class ComponentMatchingFamily<TNode extends Node>
  implements Family<TNode> {
  ...
  public constructor(nodeClass: NodeClassType<TNode>, engine: Engine) {
    ...
    const types: Map<string, ClassType<any>> = (dummyNode.constructor as any)[
      ashProp
    ]
   ...
   * remove it if so.
   */
  public componentRemovedFromEntity(
    entity: Entity,
    componentClass: ClassType<any>,
  ): void {
